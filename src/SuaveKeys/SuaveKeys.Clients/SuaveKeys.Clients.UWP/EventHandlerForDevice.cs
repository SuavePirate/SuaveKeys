    ...
    public class EventHandlerForDevice
    {
        ...
        private async void CloseCurrentlyConnectedDevice()
        {
            if (device != null)
            {
                ...
                await DeviceSelectorView.Current.Dispatcher.RunAsync(
        ...
        private void RegisterForAppEvents()
        {
            ...
            SuaveKeys.Clients.UWP.App.Current.Suspending += appSuspendEventHandler;

            SuaveKeys.Clients.UWP.App.Current.Resuming += appResumeEventHandler;
        }
